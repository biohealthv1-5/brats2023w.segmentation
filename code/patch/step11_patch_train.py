...
출력:
    outputs/checkpoints/patch/patch_best_model.pth
    outputs/logs/patch/step11_train_log.json    ← 에포크별 메트릭
    outputs/figures/patch/11_patch_training_curves.png
...
CKPT_DIR = PROJECT_DIR / "outputs" / "checkpoints" / "patch"
LOG_DIR  = PROJECT_DIR / "outputs" / "logs" / "patch"
FIG_DIR  = PROJECT_DIR / "outputs" / "figures" / "patch"
